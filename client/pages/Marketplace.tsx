...
const products = [
  {
    ...
    fallbackIcon: "🥜",
    description: "High-quality Afghan almonds, perfectly dried and sorted for premium taste and nutrition. Hand-picked from the finest orchards.",
    price: 45,
    unit: "kg",
    inStock: true,
    rating: 4.9,
  ...
  },
  {
    ...
    fallbackIcon: "🌰",
    description: "Second variety of premium Afghan almonds with distinct flavor profile and exceptional crunch.",
    price: 42,
    unit: "kg",
    inStock: true,
    rating: 4.8,
  ...
  },
  {
    ...
    fallbackIcon: "🥜",
    description: "Third variety offering unique texture and taste, harvested from select regions with optimal growing conditions.",
    price: 48,
    unit: "kg", 
    inStock: true,
    rating: 4.9,
  ...
  },
  {
    ...
    fallbackIcon: "🌰",
    description: "Fourth variety of our premium almond collection, known for exceptional quality and superior taste.",
    price: 50,
    unit: "kg",
    inStock: true,
    rating: 5.0,
  ...
  },
  {
    ...
    fallbackIcon: "🌰",
    description: "Fresh Afghan walnuts with perfect moisture content and rich flavor. Excellent for both culinary and nutritional needs.",
    price: 38,
    unit: "kg",
    inStock: true,
    rating: 4.7,
  ...
  },
  {
    ...
    fallbackIcon: "🍇",
    description: "Sweet and tender green raisins, naturally sun-dried to perfection. A healthy snack with natural sweetness.",
    price: 25,
    unit: "kg",
    inStock: true,
    rating: 4.8,
  ...
  },
  {
    ...
    fallbackIcon: "🫐",
    description: "Rich black raisins with intense flavor and natural sweetness. Perfect for desserts and healthy snacking.",
    price: 28,
    unit: "kg",
    inStock: true,
    rating: 4.6,
  ...
  },
  {
    ...
    fallbackIcon: "🍇",
    description: "Premium red raisins with balanced sweetness and soft texture. Ideal for cooking and direct consumption.",
    price: 30,
    unit: "kg",
    inStock: true,
    rating: 4.7,
  ...
  },
  {
    ...
    fallbackIcon: "🟠",
    description: "Sun-dried apricots with natural sweetness and preserved nutrients. Rich in vitamins and antioxidants.",
    price: 35,
    unit: "kg",
    inStock: true,
    rating: 4.9,
  ...
  },
  {
    ...
    fallbackIcon: "🌰",
    description: "Premium pine nuts, carefully extracted and processed for culinary excellence. Perfect for gourmet cooking.",
    price: 85,
    unit: "kg",
    inStock: true,
    rating: 5.0,
  ...
  },
  {
    ...
    fallbackIcon: "🫒",
    description: "Sweet dried figs with natural flavor and soft, chewy texture. Excellent source of fiber and minerals.",
    price: 40,
    unit: "kg",
    inStock: true,
    rating: 4.8,
  ...
  },
  {
    ...
    fallbackIcon: "🌰",
    description: "High-quality pistachios with rich taste and perfect roasting. A premium snack with excellent nutritional value.",
    price: 75,
    unit: "kg",
    inStock: true,
    rating: 4.9,
  ...
  },
  {
    ...
    fallbackIcon: "🫘",
    description: "Premium green cardamom pods with intense aroma and flavor. The queen of spices for your culinary needs.",
    price: 120,
    unit: "kg",
    inStock: true,
    rating: 5.0,
  ...
  return (
    <div className="min-h-screen dynamic-bg dark:dynamic-bg-dark">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-20 left-16 text-5xl text-blue-200/30 floating">🥜</div>
        <div className="absolute top-1/3 right-20 text-6xl text-green-200/30 floating-reverse" style={{animationDelay: '0.5s'}}>🍇</div>
        <div className="absolute bottom-32 left-1/4 text-7xl text-blue-300/30 floating" style={{animationDelay: '1s'}}>🌰</div>
        <div className="absolute top-1/2 right-1/3 text-5xl text-green-300/30 floating-reverse" style={{animationDelay: '1.5s'}}>🫐</div>
        <div className="absolute bottom-20 right-32 text-8xl text-orange-300/20 floating" style={{animationDelay: '2s'}}>🌿</div>
      </div>
              ...
              <div className="glass rounded-3xl p-8 border border-white/10">
                ...
                <div className="text-center mt-6">
                  <p className="text-gray-600 dark:text-gray-300 text-lg">
                    Showing <span className="font-bold text-primary">{filteredProducts.length}</span> premium products
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                {filteredProducts.map((product) => (
                  <Card key={product.id} className="card-3d glass border-primary/20 hover:border-primary/40 group overflow-hidden rounded-3xl">
                    <CardHeader className="text-center pb-4 relative">
                      ...
                      <div className="relative w-full h-48 mb-4 rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700">
                        ...
                        <div className="absolute top-3 right-3">
                          <Badge variant="secondary" className="bg-yellow-500/90 text-white border-0 text-xs flex items-center gap-1">
                    ...
                    <CardContent className="pt-0">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {product.features.slice(0, 2).map((feature, index) => (
                          <Badge key={index} variant="outline" className="text-xs border-primary/50 text-primary bg-primary/5">
                            {feature}
                          </Badge>
                        ))}
                      </div>
                        ...
                        <DialogContent className="glass max-w-2xl border border-white/20 rounded-3xl">
                          <DialogHeader className="text-center pb-6">
                            ...
                            <DialogDescription className="text-gray-600 dark:text-gray-300 text-lg">
                              Fill in your details to place an order. We'll contact you to confirm delivery details.
                            </DialogDescription>
                          </DialogHeader>
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="glass rounded-2xl p-6 border border-primary/20">
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <p className="font-semibold text-gray-800 dark:text-white">{selectedProduct?.name}</p>
                                </div>
                                <div>
                                  <p className="text-sm text-gray-500 dark:text-gray-400">Origin</p>
                                  <p className="font-semibold text-gray-800 dark:text-white">{selectedProduct?.origin}</p>
                                </div>
                                <div>
                                  <p className="text-sm text-gray-500 dark:text-gray-400">Price per {selectedProduct?.unit}</p>
                                  <p className="font-semibold text-primary text-xl">${selectedProduct?.price}</p>
                                </div>
                                <div>
                                  <p className="text-sm text-gray-500 dark:text-gray-400">Rating</p>
                                  <div className="flex items-center space-x-1">
                                    <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
                                    <span className="font-semibold text-gray-800 dark:text-white">{selectedProduct?.rating}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            {/* Quantity Selector */}
                            <div>
                              <Label htmlFor="quantity" className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-3 block">
                            ...
                            <div className="glass rounded-2xl p-6 border-2 border-primary/30 bg-gradient-to-br from-primary/5 to-cyan-500/5">
                              <div className="flex justify-between items-center">
                                <span className="text-xl font-semibold text-gray-700 dark:text-gray-300">Total Price:</span>
                                <span className="text-4xl font-bold text-primary">
                                  ${selectedProduct ? (selectedProduct.price * quantity).toFixed(2) : '0.00'}
                                </span>
                              </div>
                              <p className="text-sm text-gray-500 mt-2">
                                {quantity} {selectedProduct?.unit} × ${selectedProduct?.price} per {selectedProduct?.unit}
                              </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                <Label htmlFor="customerName" className="text-gray-700 dark:text-gray-300 font-semibold">
                                  Full Name *
                                </Label>
                                <Input
                                  id="customerName"
                              ...
                              <div className="md:col-span-2">
                                <Label htmlFor="notes" className="text-gray-700 dark:text-gray-300 font-semibold">
                                  Additional Notes
                                </Label>
                                <Textarea
                                  id="notes"
                          ...
                          <DialogFooter className="pt-6">
                            ...
                            >
                              <ShoppingCart className="h-5 w-5 mr-2" />
                              Place Order - ${selectedProduct ? (selectedProduct.price * quantity).toFixed(2) : '0.00'}
                            </Button>
                          </DialogFooter>
                        </DialogContent>
                      </Dialog>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="glass rounded-3xl p-12 text-center border border-white/10">
                ...
                <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 mb-12 max-w-4xl mx-auto font-medium">
                  Every product goes through <span className="text-primary font-bold">rigorous quality control</span> to ensure you receive only the finest 
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="space-y-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Premium Selection</h3>
                    <p className="text-lg text-gray-600 dark:text-gray-300">
                      Hand-picked from the finest Afghan farms with traditional expertise
                    </p>
                  </div>
                  <div className="space-y-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Expert Processing</h3>
                    <p className="text-lg text-gray-600 dark:text-gray-300">
                      Processed using traditional and modern techniques for optimal preservation
                    </p>
                  </div>
                  <div className="space-y-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Global Delivery</h3>
                    <p className="text-lg text-gray-600 dark:text-gray-300">
                      Fast and secure shipping worldwide with temperature-controlled containers
                    </p>
                  </div>
                </div>
              </div>
