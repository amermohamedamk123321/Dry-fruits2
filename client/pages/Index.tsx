  ...
  return (
    <div className="min-h-screen dynamic-bg dark:dynamic-bg-dark relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div
          className="absolute top-20 left-16 text-7xl floating drop-shadow-2xl"
        ...
        <div
          className="absolute top-1/4 right-20 text-6xl floating-reverse drop-shadow-2xl"
          style={{
            animationDelay: "0.5s",
            filter: "drop-shadow(0 25px 50px rgba(34, 211, 238, 0.4))",
          }}
        >
          <div className="transform -rotate-12 hover:rotate-0 transition-transform duration-700">
            🍇
          </div>
        </div>
        <div
          className="absolute bottom-32 left-1/4 text-8xl floating drop-shadow-2xl"
          style={{
            animationDelay: "1s",
        ...
        <div
          className="absolute top-1/2 right-1/3 text-7xl floating-reverse drop-shadow-2xl"
          style={{
            animationDelay: "1.5s",
            filter: "drop-shadow(0 25px 50px rgba(16, 185, 129, 0.4))",
          }}
        >
          <div className="transform -rotate-6 hover:rotate-6 transition-transform duration-700">
            🌰
          </div>
        </div>
        <div
          className="absolute bottom-20 right-32 text-9xl floating drop-shadow-2xl"
          style={{
            animationDelay: "2s",
        ...
        <section className="relative min-h-screen flex items-center justify-center px-6 pt-16 pb-24">
          <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left space-y-8">
              <Badge
                variant="secondary"
                className="glass text-primary border-primary/20 mb-6 px-8 py-4 text-lg font-bold animate-pulse"
              >
              ...
              <p className="text-body-lg text-readable-light max-w-3xl">
                ...
                of premium dried fruits, nuts, and spices.
                <span className="text-secondary-brand font-bold">
                  {" "}
                  Women-led enterprise
                </span>{" "}
                connecting Afghan farmers to global markets in
                <span className="text-accent-brand font-bold">
                  {" "}
                  UK, Switzerland, Dubai, France, and India
                </span>
                .
              </p>
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <Badge
                  variant="outline"
                  className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border-cyan-500/50 text-cyan-600 dark:text-cyan-400 text-lg py-3 px-6"
                >
                  👥 100+ Women Employed
                </Badge>
                <Badge
                  variant="outline"
                  className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border-green-500/50 text-green-600 dark:text-green-400 text-lg py-3 px-6"
                >
                  🤝 20 Partner Farmers
                </Badge>
                <Badge
                  variant="outline"
                  className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-blue-500/50 text-blue-600 dark:text-blue-400 text-lg py-3 px-6"
                >
                  🌍 5 Global Markets
                </Badge>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start pt-4">
                <Button
                  asChild
                  size="lg"
                  className="btn-glow bg-gradient-to-r from-primary to-cyan-500 hover:from-primary/90 hover:to-cyan-500/90 text-lg py-6 px-8 rounded-2xl"
                >
                  <Link
                    to="/marketplace"
                ...
                <Button
                  ...
                  size="lg"
                  asChild
                  className="glass border-primary/30 hover:bg-primary/10 text-lg py-6 px-8 rounded-2xl"
                >
                  <Link
                    to="/partnership"
                    className="flex items-center space-x-3"
            ...
            <div className="grid grid-cols-1 gap-8">
              ...
              <div className="card-3d glass rounded-3xl p-8 text-center transform hover:scale-105 transition-all duration-500 border-2 border-yellow-500/30">
                ...
                <h3 className="text-3xl font-display font-bold mb-4 text-gray-800 dark:text-white text-glow">
                  Best Woman in Export
                </h3>
                <p className="text-xl text-gray-600 dark:text-gray-300 mb-4">
                  Afghanistan Chamber of Commerce Award
                </p>
                <Badge
                  variant="secondary"
                  className="text-lg py-2 px-6 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-yellow-500/50"
                >
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="card-3d glass rounded-2xl p-6 text-center transform hover:scale-105 transition-all duration-300">
                  <div
                    className="text-4xl mb-4 floating-reverse"
                ...
                <div className="card-3d glass rounded-2xl p-6 text-center transform hover:scale-105 transition-all duration-300">
                  <div
                    className="text-4xl mb-4 floating"
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <h2 className="text-5xl lg:text-6xl font-display font-bold text-gray-800 dark:text-white mb-6">
                Our{" "}
                <span className="text-primary text-glow">Premium Foods</span>
              </h2>
              <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Directly sourced from Afghan farmers, processed with care, and
                exported to global markets with premium quality assurance.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              ...
              <div className="card-3d glass rounded-3xl p-8 text-center transform hover:scale-105 transition-all duration-500 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Four different varieties of high-quality Afghan almonds
                </p>
                <Badge
                  variant="outline"
              ...
              <div className="card-3d glass rounded-3xl p-8 text-center transform hover:scale-105 transition-all duration-500 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Handpicked walnuts with exceptional taste and nutrition
                </p>
                <Badge
                  variant="outline"
                  className="mb-4 border-yellow-500/50 text-yellow-600"
                >
                  Premium Quality
                </Badge>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-4">
              ...
              <div className="card-3d glass rounded-3xl p-8 text-center transform hover:scale-105 transition-all duration-500 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Green, black, and red varieties of premium raisins
                </p>
                <Badge
                  variant="outline"
                  className="mb-4 border-purple-500/50 text-purple-600"
                >
                  Bestseller
                </Badge>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-4">
              ...
              <div className="card-3d glass rounded-3xl p-8 text-center transform hover:scale-105 transition-all duration-500 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Sun-dried and machine processed Afghan apricots
                </p>
                <Badge
                  variant="outline"
                  className="mb-4 border-orange-500/50 text-orange-600"
                >
                  Natural
                </Badge>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-4">
              ...
              <div className="card-3d glass rounded-3xl p-8 text-center transform hover:scale-105 transition-all duration-500 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Premium pine nuts with exceptional flavor
                </p>
                <Badge
                  variant="outline"
                  className="mb-4 border-green-500/50 text-green-600"
                >
                  Specialty
                </Badge>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-4">
              ...
              <div className="card-3d glass rounded-3xl p-8 text-center transform hover:scale-105 transition-all duration-500 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Sweet and nutritious Afghan figs
                </p>
                <Badge
                  variant="outline"
                  className="mb-4 border-violet-500/50 text-violet-600"
                >
                  Organic
                </Badge>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-4">
              ...
              <div className="card-3d glass rounded-3xl p-8 text-center transform hover:scale-105 transition-all duration-500 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Premium Afghan pistachios with rich flavor
                </p>
                <Badge
                  variant="outline"
                  className="mb-4 border-emerald-500/50 text-emerald-600"
                >
                  Premium
                </Badge>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-4">
              ...
              <div className="card-3d glass rounded-3xl p-8 text-center transform hover:scale-105 transition-all duration-500 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Aromatic traditional Afghan spices and seasonings
                </p>
                <Badge
                  variant="outline"
                  className="mb-4 border-red-500/50 text-red-600"
                >
                  Authentic
                </Badge>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-4">
            ...
            <div className="glass rounded-3xl p-12 border border-white/10">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
                  First women-led enterprise to utilize air corridor for Afghan
                  fruit exports. Winner of "Best Woman in Export" and
                  "Afghanistan's Best Exporter" awards.
                </p>
              </div>
              ...
              <dl className="grid grid-cols-1 gap-x-8 gap-y-12 text-center lg:grid-cols-4">
                <div className="flex flex-col gap-y-4 p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20">
                  ...
                  <dt className="text-base font-medium text-gray-600 dark:text-gray-300">
                    Years in Business
                  </dt>
                  <dd className="text-5xl font-display font-bold text-primary text-glow">
                    7+
                  </dd>
                ...
                <div className="flex flex-col gap-y-4 p-6 rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
                  ...
                  <dd className="text-5xl font-display font-bold text-green-600 text-glow-green">
                    100
                  </dd>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    20 full-time, 80 seasonal
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-y-4 p-6 rounded-2xl bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-orange-900/20 dark:to-yellow-900/20">
                  ...
                  <dd className="text-5xl font-display font-bold text-orange-600">
                    20
                  </dd>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Across Afghanistan
                ...
                <div className="flex flex-col gap-y-4 p-6 rounded-2xl bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20">
                  ...
                  <dd className="text-5xl font-display font-bold text-purple-600">
                    5
                  </dd>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    UK, Switzerland, Dubai, France, India
                  </p>
                </div>
              </dl>
              ...
              <div className="mt-16 pt-8 border-t border-white/10">
                <div className="flex flex-wrap justify-center gap-6">
                  <Badge
                    variant="outline"
                    className="bg-yellow-50 dark:bg-yellow-900/20 border-yellow-500/50 text-yellow-700 dark:text-yellow-300 px-6 py-3 text-lg"
                  >
                    🏆 Best Woman in Export
                  </Badge>
                  <Badge
                    variant="outline"
                    className="bg-blue-50 dark:bg-blue-900/20 border-blue-500/50 text-blue-700 dark:text-blue-300 px-6 py-3 text-lg"
                  >
                    🥈 2nd Best Exporter of Afghanistan
                  </Badge>
                  <Badge
                    variant="outline"
                    className="bg-green-50 dark:bg-green-900/20 border-green-500/50 text-green-700 dark:text-green-300 px-6 py-3 text-lg"
                  >
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-display font-bold text-gray-800 dark:text-white mb-6">
                Our{" "}
                <span className="text-primary text-glow">Mission & Vision</span>
              </h2>
              <div className="max-w-5xl mx-auto space-y-8">
                <div className="glass rounded-3xl p-8 border border-primary/20">
                  ...
                  <p className="text-xl lg:text-2xl text-gray-700 dark:text-gray-200 leading-relaxed">
                    To enhance global access to high-quality Afghan agricultural
                    products while supporting women's economic empowerment and
                    promoting ethical, sustainable business practices.
                  </p>
                </div>
                <div className="glass rounded-3xl p-8 border border-cyan-500/20">
                  ...
                  <p className="text-xl lg:text-2xl text-gray-700 dark:text-gray-200 leading-relaxed">
                    To become the leading exporter of Afghan dried fruits, nuts,
                    and spices, recognized for quality, sustainability, and
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
              <div className="card-3d glass rounded-2xl p-8 text-center transform hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl font-display font-semibold mb-4 text-gray-800 dark:text-white">
                  Quality Excellence
                </h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Maintaining the highest standards in sourcing, processing, and
                  exporting with international food safety compliance.
                </p>
              </div>
              ...
              <div className="card-3d glass rounded-2xl p-8 text-center transform hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Providing employment and skills training for 100+ Afghan
                  women, fostering economic independence.
                </p>
              </div>
              ...
              <div className="card-3d glass rounded-2xl p-8 text-center transform hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Supporting local farmers with ethical business practices and
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 xl:grid-cols-4">
              ...
              <Card className="card-3d glass border-primary/20 hover:border-primary/40">
                <CardHeader>
                  ...
                  <CardDescription>
                    Partner with 20+ successful farmers and access international
              ...
              <Card className="card-3d glass border-primary/20 hover:border-primary/40">
                <CardHeader>
                  ...
                  <CardDescription>
                    Browse our extensive catalog of premium dried fruits and
                    nuts.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="card-3d glass border-primary/20 hover:border-primary/40">
                <CardHeader>
                  ...
                  <CardDescription>
                    Learn about our journey, mission, and commitment to
              ...
              <Card className="card-3d glass border-primary/20 hover:border-primary/40">
                <CardHeader>
                  ...
                  <CardDescription>
                    Contact our team for inquiries, custom solutions, and expert
                    consultation.
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="glass rounded-3xl p-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
                ...
                Benazir Yakta Trading Company for their premium dried fruits and
                produce trading needs.
              </p>
