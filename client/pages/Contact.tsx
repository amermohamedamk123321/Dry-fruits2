  ...
  return (
    <div className="min-h-screen dynamic-bg dark:dynamic-bg-dark">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-1/3 right-20 text-5xl text-green-200/20 floating-reverse" style={{animationDelay: '0.5s'}}>✉️</div>
        ...
        <section className="pt-32 pb-16 px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
              Have questions about our products or services? Want to become a partner? 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              ...
              <Card className="card-3d glass border-blue-500/20 hover:border-blue-500/40">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-gray-800 dark:text-white">Phone</CardTitle>
              ...
              <Card className="card-3d glass border-purple-500/20 hover:border-purple-500/40">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-gray-800 dark:text-white">Address</CardTitle>
                  <CardDescription className="text-gray-600 dark:text-gray-300">
              ...
              <Card className="card-3d glass border-orange-500/20 hover:border-orange-500/40">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-gray-800 dark:text-white">Business Hours</CardTitle>
                  <CardDescription className="text-gray-600 dark:text-gray-300">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div>
                      ...
                      <Select value={formData.inquiryType} onValueChange={(value) => setFormData({...formData, inquiryType: value})}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="orders">Product Orders</SelectItem>
              ...
              <div className="space-y-6">
                <div className="mb-8">
                  <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">
                    Global <span className="text-primary text-glow">Offices</span>
                  </h2>
                  <p className="text-gray-600 dark:text-gray-300">
                    We have offices worldwide to better serve our international partners and customers.
                  </p>
                </div>
                ...
                <Card className="card-3d glass border-blue-500/20">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <CardTitle className="text-gray-800 dark:text-white">Afghanistan (Headquarters)</CardTitle>
                        <CardDescription className="text-gray-600 dark:text-gray-300">
                ...
                <Card className="card-3d glass border-green-500/20">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <CardTitle className="text-gray-800 dark:text-white">United Kingdom</CardTitle>
                        <CardDescription className="text-gray-600 dark:text-gray-300">
                ...
                <Card className="card-3d glass border-orange-500/20">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <CardTitle className="text-gray-800 dark:text-white">Dubai, UAE</CardTitle>
                        <CardDescription className="text-gray-600 dark:text-gray-300">
                ...
                <Card className="card-3d glass border-purple-500/20">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <CardTitle className="text-gray-800 dark:text-white">India</CardTitle>
                        <CardDescription className="text-gray-600 dark:text-gray-300">
            ...
            <div className="glass rounded-3xl p-12">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-6">
                  Frequently <span className="text-primary text-glow">Asked Questions</span>
                </h2>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      We offer premium dried fruits (almonds, walnuts, raisins, apricots, figs, pistachios, pine nuts) and spices.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-2">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Yes, we ship to over 15 countries worldwide including UK, UAE, India, and many others.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-2">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Visit our Partnership page to learn about requirements and submit an application.
                    </p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      We maintain international food safety standards and conduct rigorous quality control at every stage.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-2">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Shipping times vary by destination, typically 5-15 business days depending on location.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-2">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Yes, we specialize in bulk orders for businesses and distributors with competitive pricing.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="glass rounded-3xl p-12 text-center">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                Whether you're interested in our products, partnership opportunities, or have any questions, 
                we're here to help and excited to hear from you.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="btn-glow" onClick={() => window.location.href = 'tel:+93771010170'}>
                  <Phone className="h-5 w-5 mr-2" />
                  Call Now: +93 77 10 10 70
                </Button>
                <Button variant="outline" size="lg" className="glass border-primary/30" onClick={() => window.location.href = 'mailto:Benaziryakta@gmail.com'}>
