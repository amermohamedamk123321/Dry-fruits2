...
export default function Admin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (
      credentials.username === "amirmohammad" &&
      credentials.password === "amk123321"
    ) {
        ...
        <div className="p-6">
          ...
          >
            <TabsList className="glass rounded-2xl p-2">
              <TabsTrigger value="dashboard" className="rounded-xl px-6 py-3">
                📊 Dashboard
              </TabsTrigger>
              <TabsTrigger value="orders" className="rounded-xl px-6 py-3">
                📦 Orders
              </TabsTrigger>
              <TabsTrigger value="inventory" className="rounded-xl px-6 py-3">
                📋 Inventory
              </TabsTrigger>
              <TabsTrigger value="partners" className="rounded-xl px-6 py-3">
                🤝 Partners
              </TabsTrigger>
              <TabsTrigger value="analytics" className="rounded-xl px-6 py-3">
                📈 Analytics
              </TabsTrigger>
              <TabsTrigger value="content" className="rounded-xl px-6 py-3">
                ✏️ Content
              </TabsTrigger>
            </TabsList>
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-xs text-gray-500">
                                {product.value}% • {product.sales} units • $
                                {product.revenue}
                              </div>
                            </div>
                          </div>
                ...
                <CardHeader>
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <CardDescription className="text-gray-600 dark:text-gray-300">
                        View and manage all customer orders with enhanced
                        filtering
                      </CardDescription>
                    </div>
                    <div className="flex space-x-2">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {contentData.products.map((product) => (
                    <Card
                      key={product.id}
                      className="glass border-primary/20 relative group"
                    >
                      <CardHeader>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <Card className="glass border border-white/10">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Revenue growth analysis over time
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
            ...
            <TabsContent value="content">
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Manage website content, product information, and company
                    details
                  </p>
                </div>
