...
Benazir Yakta Partnership System
      ...
      toast.success(
        "Partnership application submitted successfully! We'll contact you within 48 hours via email and phone.",
      );
  ...
  return (
    <div className="min-h-screen dynamic-bg dark:dynamic-bg-dark">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-20 left-16 text-6xl text-green-200/30 floating">
          🌾
        </div>
        <div
          className="absolute top-1/3 right-20 text-7xl text-blue-200/30 floating-reverse"
          style={{ animationDelay: "0.5s" }}
        >
          🚜
        </div>
        <div
          className="absolute bottom-32 left-1/4 text-8xl text-green-300/30 floating"
          style={{ animationDelay: "1s" }}
        >
          🌱
        </div>
        <div
          className="absolute top-1/2 right-1/3 text-6xl text-blue-300/30 floating-reverse"
            ...
            <div className="max-w-7xl mx-auto text-center">
              ...
              <p className="text-body-lg text-gray-600 dark:text-gray-300 max-w-5xl mx-auto mb-8">
                ...
                <span className="text-primary-brand font-bold">
                  20+ successful farmers
                </span>{" "}
                and access international markets while receiving{" "}
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-20">
                ...
                <h2 className="text-5xl lg:text-6xl font-display font-bold text-gray-800 dark:text-white mb-6">
                  ...
                  <span className="text-primary text-glow">Partnership</span>
                </h2>
                <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto font-medium">
                  See how our partnership program has transformed the lives of
                  ...
                  <div className="order-2 lg:order-1">
                    <div className="glass rounded-3xl p-8 border border-green-500/20 transform hover:scale-105 transition-all duration-500">
                      ...
                      <blockquote className="text-xl text-gray-700 dark:text-gray-200 italic leading-relaxed mb-6">
                        "Partnering with Benazir Yakta increased my income by
                        300%. The technical support and guaranteed market access
                        changed everything for my family. Now I can afford to
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="order-2">
                    <div className="glass rounded-3xl p-8 border border-purple-500/20 transform hover:scale-105 transition-all duration-500">
                      ...
                      <blockquote className="text-xl text-gray-700 dark:text-gray-200 italic leading-relaxed mb-6">
                        "The training programs helped me improve my farming
                        techniques. Now I produce premium quality raisins that
                        are exported to Europe! As a woman, this partnership
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <div className="order-2 lg:order-1">
                    <div className="glass rounded-3xl p-8 border border-orange-500/20 transform hover:scale-105 transition-all duration-500">
                      ...
                      <blockquote className="text-xl text-gray-700 dark:text-gray-200 italic leading-relaxed mb-6">
                        "Fair pricing and prompt payments gave me the stability
                        I needed. I've expanded my farm and now employ 10
                        additional workers. This partnership created jobs for my
                        entire community!"
                      </blockquote>
                      <div className="grid grid-cols-2 gap-4 text-center">
          ...
          <section className="py-24 px-6">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-20">
                ...
                <h2 className="text-5xl lg:text-6xl font-display font-bold text-gray-800 dark:text-white mb-6">
                  Why Partner{" "}
                  <span className="text-primary text-glow">With Us?</span>
                </h2>
                <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto font-medium">
                  We provide comprehensive support to help farmers succeed in
                  global markets
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <Card className="card-3d glass border-green-500/20 hover:border-green-500/40 group relative overflow-hidden">
                  ...
                  <CardContent className="relative z-10">
                    <p className="text-gray-600 dark:text-gray-300 text-center mb-6 text-lg leading-relaxed">
                      Receive fair and competitive prices for your produce with
                      transparent pricing policies and no hidden fees.
                    </p>
                ...
                <Card className="card-3d glass border-blue-500/20 hover:border-blue-500/40 group relative overflow-hidden">
                  ...
                  <CardContent className="relative z-10">
                    <p className="text-gray-600 dark:text-gray-300 text-center mb-6 text-lg leading-relaxed">
                      Access to agricultural experts and modern farming
                      techniques to improve your yield and quality.
                    </p>
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                ...
                <Card className="card-3d glass border-purple-500/20 hover:border-purple-500/40 group relative overflow-hidden">
                  ...
                  <CardContent className="relative z-10">
                    <p className="text-gray-600 dark:text-gray-300 text-center mb-6 text-lg leading-relaxed">
                      Direct access to international markets across 5 countries
                ...
                <Card className="card-3d glass border-orange-500/20 hover:border-orange-500/40 group relative overflow-hidden">
                  ...
                  <CardContent className="relative z-10">
                    <p className="text-gray-600 dark:text-gray-300 text-center mb-6 text-lg leading-relaxed">
                      Long-term contracts providing stability and predictable
                ...
                <Card className="card-3d glass border-teal-500/20 hover:border-teal-500/40 group relative overflow-hidden">
                  ...
                  <CardContent className="relative z-10">
                    <p className="text-gray-600 dark:text-gray-300 text-center mb-6 text-lg leading-relaxed">
                      Special programs supporting women farmers and their
                      families in agricultural development.
                    </p>
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                ...
                <Card className="card-3d glass border-indigo-500/20 hover:border-indigo-500/40 group relative overflow-hidden">
                  ...
                  <CardContent className="relative z-10">
                    <p className="text-gray-600 dark:text-gray-300 text-center mb-6 text-lg leading-relaxed">
                      Promote environmentally friendly farming practices for
              ...
              <div className="glass rounded-3xl p-8 lg:p-16 border border-white/10 bg-gradient-to-br from-white/5 to-primary/5 dark:from-black/5 dark:to-primary/5">
                <div className="text-center mb-16">
                  ...
                  <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 font-medium">
                    Fill out the application form below and we'll contact you
                    within 48 hours via email and phone
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="glass rounded-2xl p-6 border border-primary/20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <Label
                          htmlFor="fullName"
                          className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2 block"
                        >
                          Full Name *
                        </Label>
                        <Input
                  ...
                  <div className="text-center pt-8">
                    <Button
                      type="submit"
                      size="lg"
                      className="btn-glow bg-gradient-to-r from-primary to-cyan-500 hover:from-primary/90 hover:to-cyan-500/90 text-xl py-6 px-12 rounded-2xl"
                    >
            ...
            <div className="max-w-7xl mx-auto">
              <div className="glass rounded-3xl p-12 border border-white/10 bg-gradient-to-br from-primary/5 to-cyan-500/5">
                <div className="text-center mb-16">
                  ...
                  <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto font-medium">
                    Join a thriving network that's transforming Afghan
                    agriculture
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                  <div className="glass rounded-2xl p-8 border border-primary/20 transform hover:scale-105 transition-all duration-300">
                    <div className="text-6xl font-display font-black text-primary text-glow mb-4">
                      20+
                    </div>
                  ...
                  <div className="glass rounded-2xl p-8 border border-green-500/20 transform hover:scale-105 transition-all duration-300">
                    <div className="text-6xl font-display font-black text-green-500 mb-4">
                      5
                    </div>
                    <div className="text-xl font-semibold text-gray-800 dark:text-white mb-2">
                      Export Countries
                  ...
                  <div className="glass rounded-2xl p-8 border border-blue-500/20 transform hover:scale-105 transition-all duration-300">
                    <div className="text-6xl font-display font-black text-blue-500 mb-4">
                      1000+
                    </div>
                    <div className="text-xl font-semibold text-gray-800 dark:text-white mb-2">
                      Tons Traded
                  ...
                  <div className="glass rounded-2xl p-8 border border-purple-500/20 transform hover:scale-105 transition-all duration-300">
                    <div className="text-6xl font-display font-black text-purple-500 mb-4">
                      100+
                    </div>
                    <div className="text-xl font-semibold text-gray-800 dark:text-white mb-2">
                      Women Employed
